...
<svg xmlns='http://www.w3.org/2000/svg' width='300' height='300' viewBox='0 0 800 800' id="#svg1">
    <rect fill='#00000000' width='800' height='800' />
    <g fill='none' stroke='#ffffff4a' stroke-width='0.1'>
        <path
